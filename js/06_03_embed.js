...
d3.select('svg')
    .attr('width', width)
    .attr('height', height*0.73);

var f = width + height * 4.5; // works on desktop, laptop, probably it isn't that good on mobile
...
// REQUEST DATA
d3.json('../../data/06_teruleti_egyenlotlensegek_kiszoritas/habitat_onkormanyzat.geojson', function (err, json) {
    update(json)
})
